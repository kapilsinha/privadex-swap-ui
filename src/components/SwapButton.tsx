...
export default function SwapButton({ privadexApi, srcChain, areTokensSelected, areQuantitiesHighEnough, startSwap, disabled }: Props) {
  const { account, chainId, switchNetwork, activateBrowserWallet, error } = useEthers();
